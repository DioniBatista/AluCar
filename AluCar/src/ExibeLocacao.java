...
public class ExibeLocacao extends JInternalFrame{
	...
	private String [] colunas = new String []{"Codigo","CPF Cliente","Nome Cliente","Marca","Modelo","Cor","Placa","Ano","Valor Locacao","Data","Dias","Valor Total","Observação"};	  
	...
	public  ExibeLocacao()
	{
		...
		super("Locações",false,false,false,false);
